#opensource_by_Nyi Zay

#thanks_irfan_github

#my_github_https://github.com/NyiZay1000
...
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : Nyi Zay Min

\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mCountry  : Myanmar

\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : NyiZay1000
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			...
			"\r\r %s[LEE] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;92m   [LEE-OK-Just Now] %s | %s\033[0;97m         "%(uid, pw))
				...
				print("\r  \033[0;91m   [LEE-CP-7 Day] %s | %s\033[0;97m         "%(uid, pw))
